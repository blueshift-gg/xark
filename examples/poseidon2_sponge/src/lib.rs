...
mod tests {
    ...
    fn accepts_valid() {
        ...
        poseidon2_sponge("1".into(), "2".into(), "3".into(), "4".into(), "5".into(), "8828141863764826539393608139805007447022200187560478202710690249571019683634".into()).unwrap();
    }

    #[test]
    fn rejects_wrong() {
        assert!(poseidon2_sponge("1".into(), "2".into(), "3".into(), "4".into(), "5".into(), "1".into()).is_err());
    }
}
