//! Validate 3-limb incomplete secp256r1 (`a = −3`) EC ops as a `#[circuit]`:
...
#[circuit]
pub fn ec_incomplete_r1(g: Private<Point>, two_g: Public<Point>, three_g: Public<Point>) {
...
mod tests {
    ...
    fn accepts_valid() {
        let (g, g2, g3) = g123();
        ec_incomplete_r1(g, g2, g3).unwrap();
    }
    ...
    fn rejects_tampered() {
        ...
        g3[63] ^= 1; // wrong 3G
        assert!(ec_incomplete_r1(g, g2, g3).is_err());
    }
}
