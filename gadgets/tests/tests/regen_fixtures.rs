...
//! `gadgets/tests/fixtures/groth16/<name>/` from a **faithful xark-native**
...
//! purpose-built crates under `gadgets/tests/examples/<name>`.
//!
...
/// An authored fixture crate under `gadgets/tests/examples/<name>`.
