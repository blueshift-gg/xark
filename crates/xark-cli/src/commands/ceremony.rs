//! `xark ceremony` — phase-2 MPC ceremony driver (ROADMAP step **WS-F.2**).
//!
//! Subcommands:
//!
...
use groth16_backend::ceremony::{contribute, verify_chain, Contribution};
use groth16_backend::keys::{Groth16Keys, KeyMetadata};
use groth16_backend::ptau::parse_ptau;
...
fn run_init(args: InitArgs) -> Result<()> {
    ...
    use groth16_backend::NoirGroth16Circuit;
    ...
    let keys = groth16_backend::ptau::setup_from_ptau(circuit, &ptau, &seed_arr)
