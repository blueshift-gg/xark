...
/// `p.x.limbs`).
fn put3(
    inputs: &mut BTreeMap<u32, String>,
...
const R5X: [&str; 3] = [
    "33706583767550703264789043",
    "62709572061741392062833912",
    "5590589292175639374188279",
];
const R5Y: [&str; 3] = [
    "3680440249420209425139949",
    "68087786193698555118168613",
    "7199291165562692104487622",
];

// [987654321]·(2B).
const KC: [&str; 3] = ["987654321", "0", "0"];
const P2X: [&str; 3] = [
    "28581523890186841676303886",
    "55555705152498246977393751",
    "4130659841666215982649411",
];
const P2Y: [&str; 3] = [
    "68083945039146168318731209",
    "72097079905362190700201360",
    "2597539009022204787677733",
];
const RCX: [&str; 3] = [
    "3084110821577783849686387",
    "25780125767275144119022374",
    "9172652562761513664972756",
];
const RCY: [&str; 3] = [
    "23640053870041257343179867",
    "49522744475693505503098409",
    "2614569823037288618006964",
];

// EdDSA algebraic vector: [S]·B == R + [k]·A.
const AX: [&str; 3] = [
    "67250461738013543997724937",
    "51258435392452215962235818",
    "8070370278740851033482836",
];
const AY: [&str; 3] = [
    "40262224518264561256855272",
    "71970329806110551259469126",
    "8107826934435358735261814",
];
const RX: [&str; 3] = [
    "7457783715957646980183917",
    "73723665576411286276411539",
    "3192658075497919851334904",
];
const RY: [&str; 3] = [
    "2356521577147883102564275",
    "62301682795876274981280083",
    "7896457351406948862476721",
];
const S: [&str; 3] = [
    "67014997723193888983369096",
    "35374200410649094219429019",
    "721811",
];
const K: [&str; 3] = ["19669060164829260676537457", "1005", "0"];
const S_TAMPERED: [&str; 3] = [
    "67014997723193888983369097",
    "35374200410649094219429019",
    "721811",
];
...
fn smul_5b_crosscheck_and_analyzer_clean() {
    ...
    let assign = solver::solve_and_check(&program, &inputs)
        .expect("[5]·B must match the 5B reference vector");
    ...
    assert!(
        holes.is_empty(),
        "ed25519 scalar_mul under-constrained: {holes:?}"
    );
    ...
    assert!(
        ...
        "wrong [5]·B output must be rejected"
    );
}
...
fn smul_on_doubled_base_vector() {
    ...
    solver::solve_and_check(&program, &inputs)
        .expect("[987654321]·(2B) must match the reference vector");
}
...
fn eddsa_verify_honest_and_tamper() {
    ...
    assert!(
        solver::solve_and_check(&program, &bad2).is_err(),
        "tampered k must be rejected"
    );
}
